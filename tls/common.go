...
type ClientSessionState struct {
	...
	serverCertificates []*x.Certificate   // Certificate chain presented by the server
	verifiedChains     [][]*x.Certificate // Certificate chains we built for verification
}
...
type Config struct {
	...
	// for all connections.
	NameToCertificate map[string]*s.Certificate
	...
	GetCertificate func(*ClientHelloInfo) (*s.Certificate, error)
	...
	GetClientCertificate func(*CertificateRequestInfo) (*s.Certificate, error)
	...
	VerifyPeerCertificate func(rawCerts [][]byte, verifiedChains [][]*x.Certificate) error
...
func (c *Config) getCertificate(clientHello *ClientHelloInfo) (*s.Certificate, error) {
